...
vi.mock('../hooks/useAppDataController.js', () => ({
    useAppDataController: (...args) => mockUseAppDataController(...args)
}));

vi.mock('../hooks/useAppActionsController.js', () => ({
    useAppActionsController: (...args) => mockUseAppActionsController(...args)
}));

vi.mock('../hooks/useDesktopNotificationController.js', () => ({
...
vi.mock('../components/DashboardPage.jsx', () => ({ default: createStubComponent('dashboard-page') }));
vi.mock('../components/EmployeesPage.jsx', () => ({ default: createStubComponent('employees-page') }));
vi.mock('../components/DepartmentsPage.jsx', () => ({ default: createStubComponent('departments-page') }));
vi.mock('../components/PositionsPage.jsx', () => ({ default: createStubComponent('positions-page') }));
...
vi.mock('../components/DevelopmentOnboardingModalsHost.jsx', () => ({ default: createStubComponent('development-onboarding-modals-host') }));
