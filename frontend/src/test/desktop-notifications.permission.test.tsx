...
import { ensureDesktopNotificationPermission } from '../desktopNotifications.ts';
import { NOTIFICATION_PERMISSION_PROMPT_STORAGE_KEY } from '../desktopNotifications/constants.ts';
import {
  applyBaseDomSetup,
